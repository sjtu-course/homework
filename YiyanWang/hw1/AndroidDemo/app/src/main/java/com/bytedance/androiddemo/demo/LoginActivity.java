...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharePref = getSharedPreferences("keywords",Context.MODE_PRIVATE);
        mEtRoomID.setText(sharePref.getString("roomId", ""));
        mEtUserName.setText(sharePref.getString("userName",""));
