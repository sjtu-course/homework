...
BOOL CRTCDemoDlg::OnInitDialog()
{
	...
	CString strPath = TEXT(".\\LoginInfo.ini");
	CFileStatus status;
	...
	if (CFile::GetStatus(strPath, status))
	{
		...
		TCHAR* pUserName = new TCHAR[dFileSize];
		TCHAR* pRoomName = new TCHAR[dFileSize];

		GetPrivateProfileString(TEXT("LoginInfo"),
								TEXT("room_name"),
								TEXT("Error: failed"),
								pRoomName,
								dFileSize,
		...
		CString user_name = pUserName;
		CString room_name = pRoomName;
...
void CRTCDemoDlg::OnBnClickedLogin()
{
	...
	WritePrivateProfileStringW(NULL, NULL, NULL, L".\\LoginInfo.ini");
	// Write login information to the INI file.
	WritePrivateProfileString(TEXT("LoginInfo"),
							  TEXT("room_name"),
							  pRoomName,
							  TEXT(".\\LoginInfo.ini"));
	WritePrivateProfileString(TEXT("LoginInfo"),
