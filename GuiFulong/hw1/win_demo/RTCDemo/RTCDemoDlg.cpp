...
BOOL CRTCDemoDlg::OnInitDialog()
{
	...
	CString strTemp;
	GetPrivateProfileString(_T("test"), _T("user_name"), _T(""), strTemp.GetBuffer(MAX_PATH), MAX_PATH, _T("D:\\IniFileName.ini"));
	m_name.SetWindowTextW(strTemp);
	GetPrivateProfileString(_T("test"), _T("room_name"), _T(""), strTemp.GetBuffer(MAX_PATH), MAX_PATH, _T("D:\\IniFileName.ini"));
	m_room.SetWindowTextW(strTemp);
...
void CRTCDemoDlg::OnBnClickedLogin()
{
	...
	WriteProfileString(_T("test"), _T("user_name"), user_name);
	//build INI 
	LPTSTR lpPath = _T("D:\\IniFileName.ini");
	WritePrivateProfileString(_T("test"), _T("user_name"), user_name, _T("D:\\IniFileName.ini"));
	WritePrivateProfileString(_T("test"), _T("room_name"), room_name, _T("D:\\IniFileName.ini"));
