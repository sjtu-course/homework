...
- (void)viewDidLoad {
    ...
    roomInput.text = [[NSUserDefaults standardUserDefaults] objectForKey:@"roomInput"];
    ...
    nameInput.text = [[NSUserDefaults standardUserDefaults] objectForKey:@"nameInput"];
...
- (void)enterButtonTapped:(id)sender {
    ...
    NSString* textField1Text = _roomInput.text;
    [defaults setObject:textField1Text forKey:@"roomInput"];
    NSLog(@"%@",textField1Text);
    NSLog(@"clicked!!");
    
    NSString* textField2Text = _nameInput.text;
    [defaults setObject:textField2Text forKey:@"nameInput"];
    NSLog(@"%@",textField2Text);
