...
BOOL CRTCDemoDlg::OnInitDialog()
{
	...
	// read default when init
	CString user_name, room_name;
	GetPrivateProfileString(L"user", L"user_name", L"", user_name.GetBuffer(30), 30, L"./cache.ini");
	GetPrivateProfileString(L"user", L"room_name", L"", room_name.GetBuffer(30), 30, L"./cache.ini");
...
void CRTCDemoDlg::OnBnClickedLogin()
{
	...
	WritePrivateProfileString(L"user", L"user_name", user_name, L"./cache.ini");
	WritePrivateProfileString(L"user", L"room_name", room_name, L"./cache.ini");
