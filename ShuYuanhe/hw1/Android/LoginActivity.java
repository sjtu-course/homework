...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String init_room = sharedPreferences.getString("room", "");
        String init_name = sharedPreferences.getString("name", "");
        mEtRoomID.setText(init_room);
        mEtUserName.setText(init_name);
        ...
        mBtnJoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Reference:https://blog.csdn.net/brooksjames/article/details/80039928
                SharedPreferences sharedpreferences = getSharedPreferences("Init", Context.MODE_PRIVATE);
